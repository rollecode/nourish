...
pub fn interactive(base: Environment) -> Environment {
    ...
    Environment {
        ...
        // Window border widths and the placeholder toggle: carried through
        // unprompted (edit in the in-compositor settings window instead).
        window_border_active: base.window_border_active,
        window_border_secondary: base.window_border_secondary,
